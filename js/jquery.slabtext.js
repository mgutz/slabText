    ...
    $.fn.slabText = function(options) {
        ...
        return this.each(function(){
            ...
            var $this               = $(this),
                ...
                origFontSize        = null,
                idealCharPerLine    = idealCharPerLine,
                ...
                maxCharPerLine      = settings.maxCharPerLine
            ...
            var resizeSlabs = function resizeSlabs() {
                ...
                if(!keepSpans && (forceNewCharCount || fs != origFontSize)) {
                    ...
                    var newCharPerLine      = Math.min(maxCharPerLine, Math.floor(parentWidth / (origFontSize * fontRatio))),
                        wordIndex           = 0,
                        lineText            = [],
                        counter             = 0,
                        preText             = "",
